...
namespace AmaruCommon.GameAssets.Player
{
    ...
    public class EnemyInfo
    {
        ...
        public EnemyInfo(CharacterEnum character, int health, int mana, int deckSize, int handSize, List<CreatureCard> inner, List<CreatureCard> outer, SpellCard playedSpell, bool immune)
        {
