        ...
        public static Card GetLunaCard(Luna card)
        {
            switch (card)
            {
                ...
                case Luna.Rattlesnake:
                    return new CreatureCard(new CardEnum(card), "Rattlesnake", 4, 4, new PoisonAttack(1, 2), ability: new KillIfPDAbility(1, 2, 2));
        ...
        public static Card GetYakuCard(Yaku card)
        {
            switch (card)
            {
                ...
                case Yaku.RoyalStarfish:
                    return new CreatureCard(new CardEnum(card), "Royal Starfish", 2, 2, new SimpleAttack(1, 1), ability: new GiveEPAbility(1,1,1));
